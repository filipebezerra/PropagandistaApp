...
public class OnItemTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    @NonNull private GestureDetector mGestureDetector;
    @NonNull private OnItemClickListener mListener;

    public OnItemTouchListener(@NonNull Context context, @NonNull RecyclerView recyclerView,
